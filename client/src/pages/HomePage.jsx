  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="container mx-auto space-y-10">
        ...
        ) : (friends.length === 0 ? (<NoFriendsFound />) : (<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {friends.map((friend) => (
        ...
        <section>
          ...
          ) : recommendedUsers.length === 0 ? (<NoRecommendedUsersFound />) : (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
